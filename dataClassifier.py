...
def readCommand( argv ):
  ...
  if(options.classifier == "mostFrequent"):
    ...
    #else:
          #print("Smoothing parameter k=%f" %  options.smoothing)
...
def runClassifier(args, options):
  ...
  #print("Step1: Feature Extraction - Done")
  ...
  #print("Step2: Training - Done")

  guesses = classifier.classify(testData)
  correct = [guesses[i] == testLabels[i] for i in range(len(testLabels))].count(True)
  #print("Step3: Testing - Done")
  print("Training time: ", train_time)
  print("Accuracy: %.1f%%" % (100.0 * correct / len(testLabels)))
  #print(str(correct), ("correct out of " + str(len(testLabels)) + " (%.1f%%).") % (100.0 * correct / len(testLabels)))
  #print("")
  #analysis(classifier, guesses, testLabels, testData, rawTestData, printImage)

  predictionError = (len(testLabels) - correct) / len(testLabels)
  print("Prediction Error: " + str(predictionError))
  upperLimit = predictionError + 1.96 * math.sqrt((predictionError * (1.0 - predictionError)) / len(testLabels))
  lowerLimit = predictionError - 1.96 * math.sqrt((predictionError * (1.0 - predictionError)) / len(testLabels))
  standardDeviation = math.sqrt(len(testLabels)) * (upperLimit - lowerLimit) / 3.92
